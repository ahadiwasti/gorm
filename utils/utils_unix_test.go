...
func TestSourceDir(t *testing.T) {
	cases := []struct {
		...
		{
			file: "/Users/name/go/pkg/mod/github.com/ahadiwasti/gorm@v1.2.3/utils/utils.go",
		...
		{
			file: "/go/work/proj/my.github.com/ahadiwasti/gorm@v1.2.3/utils/utils.go",
			want: "/go/work/proj/my.github.com/ahadiwasti/gorm@v1.2.3/",
		},
	}
	for _, c := range cases {
		s := sourceDir(c.file)
